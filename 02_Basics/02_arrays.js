...
// console.log(marverl_heros[3][0]);

// const allHeros = marverl_heros.concat(dc_heros)
// console.log(allHeros);

const all_new_heros = [...marverl_heros, ...dc_heros] //Spread kaanch ka gilash neeche gira aur spred ho gya.
...
console.log(Array.from({name: "Radhe"})) //interesting case for interview
